...
Page({
  ...
  changePage: function (event) {
    let cur_data = this.data.buildlData
    this.setData({
      isSelectedBuildType: event.currentTarget.id,
      isSelectedBuild: 0,
      longitude: cur_data[event.currentTarget.id].data[0].longitude,
      latitude: cur_data[event.currentTarget.id].data[0].latitude,
      markers: cur_data[event.currentTarget.id]
    });
  }
})